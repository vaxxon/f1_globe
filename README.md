...
This project was built for INFO-609 Intro to GIS at Pratt Institute. You can see it in action at [my website](http://vincentallport.com/f1_globe). It consists of:
